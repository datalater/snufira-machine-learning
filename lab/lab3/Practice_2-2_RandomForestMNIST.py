...
X = train[features]
y = train['label']
X_train, X_test, y_train, y_test = cross_validation.train_test_split(X/255.,y,test_size=0.1,random_state=0) # automatically split train (0.9) and test (0.1) data
...
y_pred_rf = clf_rf.predict(X_test)                 # prediction for test data
